...
export type ScheduledOperationAffectedDocument = Asset | Post | Seo;
...
export type GetPostsPagesQueryVariables = Exact<{ [key: string]: never; }>;
...
export type GetPostsSlugsQuery = { __typename?: 'Query', posts: Array<{ __typename?: 'Post', slug?: string | null }> };
...
export const GetPostsPagesDocument = gql`
    query GetPostsPages {
  postsConnection {
    pageInfo {
      pageSize
...
/**
 * __useGetPostsPagesQuery__
 *
 * To run a query within a React component, call `useGetPostsPagesQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetPostsPagesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetPostsPagesQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetPostsPagesQuery(baseOptions?: Apollo.QueryHookOptions<GetPostsPagesQuery, GetPostsPagesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetPostsPagesQuery, GetPostsPagesQueryVariables>(GetPostsPagesDocument, options);
      }
export function useGetPostsPagesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetPostsPagesQuery, GetPostsPagesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetPostsPagesQuery, GetPostsPagesQueryVariables>(GetPostsPagesDocument, options);
        }
